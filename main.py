...
logger.setLevel(10)
logger.addHandler(AzureLogHandler(connection_string='InstrumentationKey=eda544dded324f158d83efbc0306abd2'))

headers = {
    "Ocp-Apim-Subscription-Key": "eda544dded324f158d83efbc0306abd2",
